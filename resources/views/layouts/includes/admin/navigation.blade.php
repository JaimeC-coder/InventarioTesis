                    ...
                    @else
                        ...
                        <li>
                            <a href="{{ route($link['route']) }}"
                                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ $link['active'] ?? false ? 'bg-gray-100 font-semibold dark:bg-gray-700' : '' }}">
                                <x-dynamic-component :component="'icons.' . $link['icon']" />
