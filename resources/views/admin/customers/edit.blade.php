    ...
    <div
        ...
        <form action="{{ route('admin.customers.update', $customer) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    <label for="identity_id"
                        class="block text-sm font-medium text-gray-700 dark:text-white text-left">Tipo de
                        Identidad</label>
                ...
                <div class="mb-4">
                    <label for="document_number"
                        class="block text-sm font-medium text-gray-700 dark:text-white text-left">Número del
                        Documento</label>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    <label for="email"
                        class="block text-sm font-medium text-gray-700 dark:text-white text-left">Correo
                        Electrónico</label>
