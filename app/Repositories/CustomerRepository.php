...
class CustomerRepository
{
    public function topByRevenue(array $filters, string $direction, int $limit)
    {
        ...
        $this->applyDateFilters($builder, $filters, 'sales.date');

        return $builder->orderBy('total_revenue', $direction)->limit($limit)->get();
    }
    ...
    public function topByPurchaseCount(array $filters, string $direction, int $limit)
    {
        ...
        return $builder->orderBy('purchase_count', $direction)->limit($limit)->get();
    }
