...
class PurchaseOrderRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'total.min' => 'El total debe ser al menos 1.',
            ...
            'products.*.quantity.numeric' => 'La cantidad del producto debe ser un número.',
            'products.*.quantity.min' => 'La cantidad del producto debe ser al menos 1/4. del empaque.',
